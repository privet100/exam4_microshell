...
test_line /bin/ls ";" /bin/ls microshell.c ";" /bin/ls Readme.md ";"
test_line /bin/ls "|" /usr/bin/grep micro ";" /bin/ls "|" /usr/bin/grep micro ";" /bin/ls "|" /usr/bin/grep micro ";" /bin/ls "|" /usr/bin/grep micro ";"
test_line /bin/cat Readme.md "|" /usr/bin/grep a "|" /usr/bin/grep b ";" /bin/cat Readme.md ";"
test_line /bin/cat Readme.md ";" /bin/cat Readme.md "|" /usr/bin/grep a "|" /usr/bin/grep b "|" /usr/bin/grep z ";" /bin/cat Readme.md
test_line ";" /bin/cat Readme.md ";" /bin/cat Readme.md "|" /usr/bin/grep a "|" /usr/bin/grep b "|" /usr/bin/grep z ";" /bin/cat Readme.md
